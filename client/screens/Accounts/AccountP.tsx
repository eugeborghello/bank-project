...
export default function AccountP({ navigation }) {
	return (
		<View style={styles.view}>
			<View style={styles.viewMenu}>
				<MaterialCommunityIcons name="menu" size={26} color="white" style={{ top: 15 }} />
			...
			<View style={styles.container}>
				...
				<View style={styles.viewButton}>
					...
					<View style={styles.viewButtonRow}>
						...
						>
							<MaterialCommunityIcons name="account-cog" size={20} color="black" />
