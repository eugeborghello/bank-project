...
export default function Profile() {
	...
	useEffect(() => {
		axios
			.patch(
				`${REACT_APP_BACKEND_API_URL}/users/${user[0]._id}`,
				{ imgUrl: selectedImage.localUri },
				{
					headers: {
	...
	useEffect(() => {
		axios
			.get(`${REACT_APP_BACKEND_API_URL}/accounts/${user[0]._id}`, {
				headers: {
					Authorization: `${user[0].tokens[0].token}`,
				},
			})
	...
	return (
		<View style={styles.profile}>
			...
			<View style={styles.fotocontainer1}>
				<Image source={require("../../assets/images/Profile2.jpg")} style={styles.foto1} />
			</View>
				...
				<View style={styles.centeredView}>
					<View style={styles.modalView}>
						...
						<View style={styles.buttons}>
							<TouchableOpacity onPress={() => openImage()} style={styles.options}>
			...
			<View style={styles.generalView}>
				<Pressable style={styles.fotocontainer} onPress={() => setModalVisible(true)}>
